...
const MIGRATED_PATHS: string[] = [
  ...
  'app/dashboard/finance/client-statement',
  'app/dashboard/finance/contracts',
  'app/dashboard/finance/credit-notes',
  'app/dashboard/finance/expenses',
  'app/dashboard/finance/purchase-orders',
  'app/dashboard/finance/recurring',
  'app/dashboard/finance/reports',
  'app/dashboard/finance/suppliers',
  'app/dashboard/finance/targets',
  'components/quotes',
  'components/finance',
  'components/dashboard/invoice-detail',
  'components/dashboard/invoice-new',
  'components/dashboard/client-statement',
  'components/dashboard/finance-overview',
  'components/dashboard/finance-reports',
  'components/dashboard/recurring-list',
  'components/dashboard/recurring-new',
  'components/dashboard/supplier-detail',
  'components/dashboard/finance-targets',
  'components/reports',
  'app/api/invoices',
  'app/api/quotes',
  'app/api/finance',
  ...
  'app/dashboard/leave',
  'app/dashboard/timesheet',
  'app/dashboard/payroll',
  'app/dashboard/my-payslips',
  'app/dashboard/my-documents',
  'app/dashboard/hr',
  ...
  'app/api/leave',
  'app/api/timesheet',
  'app/api/dashboard/timesheet-periods',
  'app/api/my-documents',
  'app/api/my-productivity',
  'app/api/dashboard/attendance',
  'app/api/dashboard/payroll',
  'app/api/dashboard/leave',
  'app/api/dashboard/evaluations',
  'hooks/useAttendance.ts',
  'hooks/usePayroll.ts',
  'hooks/useEmployeePayments.ts',
  'hooks/useLeave.ts',
  'hooks/useEvaluations.ts',
  'hooks/useHROverview.ts',
