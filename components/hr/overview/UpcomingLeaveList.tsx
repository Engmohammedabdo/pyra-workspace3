  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-card/80 backdrop-blur-sm shadow-sm overflow-hidden">
      ...
      <Link
        ...
        aria-label="افتح صفحة الإجازات القادمة"
        className={cn(
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-bold text-sm">الإجازات القادمة (7 أيام)</h3>
          {items.length > 0 && (
      ...
      <div className="divide-y divide-border/40">
        {items.length > 0 ? (
          ...
          <div className="px-5 py-6 flex flex-col gap-1">
            <p className="text-sm text-muted-foreground">لا توجد إجازات قادمة في الأيام السبعة القادمة</p>
          </div>
        )}
      </div>
    </div>
