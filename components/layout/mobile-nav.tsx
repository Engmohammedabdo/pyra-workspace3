...
const mobileNavGroups: MobileNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/dashboard/crm', label: 'نظرة عامة', icon: TrendingUp, permission: 'sales.view' },
      { href: '/dashboard/crm/pipeline', label: 'العملاء المحتملين', icon: UserPlus, permission: 'sales_leads.view' },
      ...
      { href: '/dashboard/crm/follow-ups', label: 'المتابعات', icon: Clock, permission: 'sales_leads.view' },
      { href: '/dashboard/crm', label: 'تقارير المبيعات', icon: BarChart3, permission: 'sales.view' },
