  ...
  return (
    <motion.div variants={containerMotion} initial="hidden" animate="show" className="space-y-8">
      ...
      <motion.div variants={itemMotion} className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[ { label: 'إضافة عميل', href: '/dashboard/crm/pipeline', icon: UserCheck, color: 'from-orange-400 to-amber-500' }, { label: 'المحادثات', href: '/dashboard/sales/chat', icon: Phone, color: 'from-emerald-400 to-teal-500' }, { label: 'المتابعات', href: '/dashboard/crm/follow-ups', icon: Clock, color: 'from-violet-400 to-purple-500' }, { label: 'التقارير', href: '/dashboard/crm', icon: BarChart3, color: 'from-blue-400 to-indigo-500' } ].map((a, i) => (
