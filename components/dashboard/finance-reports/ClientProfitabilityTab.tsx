          ...
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead><tr className="border-b text-muted-foreground"><th className="text-right py-3 px-2 font-medium">العميل</th><th className="text-right py-3 px-2 font-medium">الشركة</th><th className="text-right py-3 px-2 font-medium">الإيرادات</th><th className="text-right py-3 px-2 font-medium">المصاريف</th><th className="text-right py-3 px-2 font-medium">الربح</th><th className="text-right py-3 px-2 font-medium">الهامش</th><th className="text-right py-3 px-2 font-medium">العقود</th></tr></thead>
