...
export const MODULE_GUIDES: Record<string, ModuleGuide> = {
  ...
  '/dashboard/crm/pipeline': {
    ...
    tips: [
      ...
      'سايد barr الـ admin يفلتر بالأولوية + المصدر + الوكيل المسؤول؛ الوكيل يرى عملاءه فقط (أمن صارم)',
    ...
    keywords: ['leads', 'عملاء محتملين', 'kanban', 'pipeline', 'مبيعات', 'lifecycle', 'تحويل', 'closed won', 'تأهيل'],
  },
  '/dashboard/calendar': {
