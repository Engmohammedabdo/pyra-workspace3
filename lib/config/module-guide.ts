...
export const MODULE_GUIDES: Record<string, ModuleGuide> = {
  ...
  '/dashboard/settings': {
    ...
    goal: 'خصّص إعدادات مساحة العمل: معلومات الشركة، بادئات الفواتير والعروض، البيانات البنكية، التخزين، البورتال، ومفاتيح API.',
    tips: [
      'استخدم تبويب "عام" لضبط بيانات الشركة والفواتير والبنك',
      'استخدم تبويب "مفاتيح API" لإنشاء مفاتيح التكامل الخارجي',
      'تبويب "إعدادات الأنظمة" يوفر روابط سريعة لإعدادات المبيعات والإجازات والتقييم',
      'التغييرات تُطبق فوراً على النظام بعد الحفظ',
    ],
    keywords: ['settings', 'إعدادات', 'تخصيص', 'شعار', 'فاتورة', 'بنك', 'API', 'بورتال'],
  },
