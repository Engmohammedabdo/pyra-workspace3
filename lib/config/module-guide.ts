...
export const MODULE_GUIDES: Record<string, ModuleGuide> = {
  ...
  '/dashboard/clients': {
    ...
    description: 'إدارة بيانات العملاء وتاريخ التعامل',
    descriptionEn: 'Manage client data and interaction history',
    goal: 'قاعدة بيانات شاملة للعملاء: معلومات الاتصال، الشركة، المشاريع المرتبطة، الفواتير، والعقود.',
    tips: [
      'أضف عميل جديد من الزر أعلى الصفحة',
      'ربط العميل بمشاريعه لتتبع الربحية',
      'كل عميل يحصل على حساب في بوابة العملاء تلقائياً',
      'استخدم البحث والفلترة للوصول السريع',
    ],
    keywords: ['clients', 'عملاء', 'شركات', 'جهات اتصال'],
  },
