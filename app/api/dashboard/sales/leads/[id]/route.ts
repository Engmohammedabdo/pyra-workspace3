...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /api/dashboard/sales/leads/[id]] error:', err);
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[PATCH /api/dashboard/sales/leads/[id]] error:', err);
    return apiServerError();
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /api/dashboard/sales/leads/[id]] error:', err);
    return apiServerError();
  }
}
